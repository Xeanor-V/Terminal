...
namespace Google.AR.Core.Exceptions {
	...
	public partial class UnavailableDeviceNotCompatibleException : global::Google.AR.Core.Exceptions.UnavailableException {
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/google/ar/core/exceptions/UnavailableDeviceNotCompatibleException", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (UnavailableDeviceNotCompatibleException); }
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (UnavailableDeviceNotCompatibleException)) {
					SetHandle (
