...
namespace Google.AR.Core.Exceptions {
	...
	public partial class ResourceExhaustedException : global::Java.Lang.Exception {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/google/ar/core/exceptions/ResourceExhaustedException", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ResourceExhaustedException); }
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (ResourceExhaustedException)) {
					SetHandle (
