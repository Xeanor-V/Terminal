...
namespace Google.AR.Core {
	...
	public partial class InstallActivity : global::Android.App.Activity {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/google/ar/core/InstallActivity", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (InstallActivity); }
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (InstallActivity)) {
					SetHandle (
