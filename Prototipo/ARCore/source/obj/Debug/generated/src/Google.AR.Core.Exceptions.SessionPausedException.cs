...
namespace Google.AR.Core.Exceptions {
	...
	public partial class SessionPausedException : global::Java.Lang.IllegalStateException {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/google/ar/core/exceptions/SessionPausedException", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (SessionPausedException); }
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (SessionPausedException)) {
					SetHandle (
